...
5. **Entrega Final:** Faça o último `commit` (ex: `feat: animacoes css, logica de exclusao e interatividade`) e o `push` final. Envie o link do repositório para o professor.# index-poquemom
